...
| plan_name | customer_ct | round(100*count(distinct customer_id)/
        (select count(distinct customer_id) from subscriptions),2) |
| --------- | ----------- | --------------------------------------------------------------------------------------------------------- |
| churn     | 307         | 30.7                                                                                                      |
...
| plan_id | churner_ct | churner_percentage |
| ------- | ---------- | ------------------ |
| 0       | 92         | 9.2                |
...
| plan_id | retention_ct | retention_percentage |
| ------- | ------------ | -------------------- |
| 1       | 546          | 54.6                 |
| 2       | 325          | 32.5                 |
| 3       | 37           | 3.7                  |
...
| plan_id | plan_name     | customer_ct | percentage |
| ------- | ------------- | ----------- | ---------- |
| 0       | trial         | 19          | 1.9        |
